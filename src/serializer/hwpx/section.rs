...
fn render_common_shape_xml(
    ...
    let mut out = format!(
        concat!(
            ...
            "{block}",
            "{geometry}",
            r#"<hp:sz width="{w}" height="{h}" widthRelTo="{wrt}" heightRelTo="{hrt}"/>"#,
        ...
        w = c.width,
        h = c.height,
        wrt = super::shape::size_criterion_to_hwpx(c.width_criterion),
        hrt = super::shape::size_criterion_to_hwpx(c.height_criterion),
