...
fn compute_line_extra_spacing(
    ...
    if needs_justify {
        ...
        // 마지막 글자가 slack/N 만큼 안쪽으로 밀려 줄마다 오른쪽 끝이 어긋난다.
        // 한컴은 줄 길이와 무관하게 오른쪽 끝을 문단 폭에 맞춘다(이슈
        // 20260905-174236 한컴 PDF 실측: 셀 내부 폭 44.2pt 에 「학 번」 43.9pt·
        // 「E-mail」 44.3pt). 말미 공백은 보이는 글자가 아니므로 분배 대상과
        // 기준 폭에서 제외한다.
...
mod issue_4657_distribute_alignment_tests {
    ...
    /// (이슈 20260905-174236: 「학번」 2자와 「E-mail」 6자가 같은 셀 폭을 채운다)
    #[test]
